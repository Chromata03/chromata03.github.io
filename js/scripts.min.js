...
// Profile image modal (lightbox) feature
$(document).ready(function() {
    var modal = $('#profileImageModal');
    var modalImg = $('#modalProfileImg');
    var profileImg = $('#about-profile-img');
    ...
    $(document).on('keydown', function(e) {
        if (modal.is(':visible') && (e.key === 'Escape' || e.key === 'Esc' || e.keyCode === 27)) {
            modal.hide();
        }
    });
});